...
```
Cat.prototype = new Super();``})();``// Test Code``var cat = new Cat();``console.log(cat.name);``console.log(cat.sleep());``console.log(cat instanceof Animal); // true``console.log(cat instanceof Cat); //true
```
